...
<?if ( $sub_code !="" && $sub_code=="evntList" ){?>
<a href="./xlsData/enterForEventSampleData.xls"><font color=red>이벤트 응모고객 샘플엑셀다운로드</font></a> ( 샘플데이타의 노란색은 이벤트 응모 고객에 해당됩니다. )
<?}else{?>
<a href="./xlsData/buyCustomerSampleData.xls"><font color=red>구입고객 샘플엑셀다운로드</font></a> ( 샘플데이타의 노란색은 이벤트 응모 고객에 해당됩니다. )
<?}?>
</div>
<br /><br />
